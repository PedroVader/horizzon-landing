      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-6 lg:px-8">
        <div className="max-w-5xl">
          ...
          <div className={`flex flex-col sm:flex-row gap-4 md:gap-6 transition-all duration-1000 delay-500 ${
            ...
            <button className="group relative overflow-hidden bg-[#222952] text-white px-8 md:px-10 py-4 md:py-4 rounded-full font-bold text-lg md:text-base hover:scale-105 hover:shadow-xl transition-all duration-300 shadow-lg">
