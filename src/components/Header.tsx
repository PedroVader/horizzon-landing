    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <a href="#top" className="flex items-center group">
              <img
                ...
                className={`object-contain transition-all duration-500 ${
                  scrolled ? 'h-25 md:h-20' : 'h-20 md:h-25 lg:h-20'
        ...
        <div className={`lg:hidden overflow-hidden transition-all duration-500 ${
          ...
          <div className="border-t border-[#F8FAED] bg-white/95 backdrop-blur-sm">
      ...
      {/* Mobile Menu Overlay */}
      <div className={`lg:hidden fixed inset-0 bg-black/20 backdrop-blur-sm transition-all duration-500 ${
        isMenuOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
      }`} style={{ top: scrolled ? '64px' : '80px' }} onClick={() => setIsMenuOpen(false)} />
    </header>
  );
};
